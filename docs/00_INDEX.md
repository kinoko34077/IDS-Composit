...
v0.2作業では、現在のユーザー指示、`v0.2/00_INDEX.md`の対象章、v0.1互換基準の順で参照する。v0.1文書の旧Pipelineは互換条件としてのみ読み、v0.2の責務・resolver順序は`docs/v0.2/`を正本とする。
...
- `validation/V0.2_FIRST_SLICE.md`: v0.2 first sliceのlocal gate、Actions、Pages実ブラウザ確認
