...
|---|---|---|
|REQ-001|Phase 5: CHISE Adapter（未実装）|Phase 5 fixture/live smoke（未実装）|
...
|REQ-003|Phase 5: Resolver（未実装）|Phase 5 native resolution test（未実装）|
...
|REQ-013|Phase 5: Resolver（未実装）|Phase 5 outage test（未実装）|
